...
class App extends Component {
  ...
  assignFlavor = (e) => {
    this.setState({currentItem: Object.assign({}, this.state.currentItem, {flavor: e.target.dataset.flavor})}, () => this.calculateCost('vessel'))
  }
  assignVessel = (e) => {
  ...
  addItemToOrder = (e) => {
    ...
    this.setState({order, currentItem: blankItem}, () => this.scroll(false, "type"))
  }
  scroll = (e, t) => {
    document.getElementById(e ? e.target.dataset.scrollto : t).scrollIntoView({behavior: "smooth"})
  }
  checkout = () => {
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <body>
          {/* WELCOME */}
          <section id="welcome" className="question first">
            <p>
              Let's start with your name
              <br style={{marginBottom: '20px'}} />
              <input name="customerName" data-next="type" onKeyUp={this.checkIfEnter} onChange={this.setCustomerName} />
            </p>
            <OK target="type" scroll={this.scroll} />
          </section>
          ...
          <section className="question" id="flavor">
            <p>OK! What flavour of {humanNames[this.state.currentItem.type] || "____"} would you like?</p>
            <p>
            ...
            <OK target="vessel" scroll={this.scroll} />
          </section>
          ...
          <section className="question" id="addItem">
            ...
            <p>
              Would you like to add another item to your order?
              <p className="itemGroup">
